        ...
        <div class="lay_right">
            <form>
                <table>
                    ...
                    <tr>
                        <td>库存量</td>
                        <td><input type="text" name="gstock" value="${goods.gstock}"></td>
                    </tr>
                    <tr>
                        <td>描述</td>
                        <td><input type="text" name="gdesc" value="${goods.gdesc}"></td>
                    </tr>
                    <tr>
                        <td>分类</td>
                        <td>
  ...
  //同步实现
       ...
       $.ajax({
           ...
           success:function(result){
               $(result).each(function () {
                   if(cidv==this.cid){
                       str+="<option value="+this.cid+" selected>"+this.cname+"</option>"
                   }else{
                   str+="<option value="+this.cid+">"+this.cname+"</option>"
                   }
               })
